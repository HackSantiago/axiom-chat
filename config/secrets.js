...
module.exports = {
  ...
  twitter: {
    consumerKey: process.env.TWITTER_KEY || 'f5t80SlTwABvvQxsNClNLFg21',
    consumerSecret: process.env.TWITTER_SECRET  || '6hm26DiZMW6uQIp6i4uDp17GD2R4MGNTrbB7VRmd5RvLB6kXcX',
